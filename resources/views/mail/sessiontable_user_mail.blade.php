                        ...
                        <tr class="header"
                            ...
                            <td class="header-menu d-flex justify-content-center align-items-center" style="display: block; padding: 10px 32px;text-align: center;">
                                <ul>
                                    ...
                                    <li>
                                        <a href="{{ route('front.sessiontable') }}">{{ __('general.contact')}}</a>
                                    </li>
                                </ul>
                            </td>
                        </tr>
                    ...
                    <table class="text-center footer-table" align="center" border="0" cellpadding="0" cellspacing="0"
                        ...
                        <tr>
                            <td>
                                ...
                                letter-spacing:1px; font-weight: 500;">{{ settings()->copyright }}    <strong>  {{ __('general.developed_by') }} <a class="font-weight-bold text-primary" href="https://yousab-tech.com/yousab-tech/public"> {{ __('general.yousab_tech') }}</a></strong></h5>
                                        </td>
                                    </tr>
                                </table>
                            </td>
