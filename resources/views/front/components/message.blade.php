                            ...
                            <div class="col-12">
                                <div class="mb-md-4 mb-3 custom-form">
                                    ...
                                    <div class="custom-textarea">
                                        <textarea class="form-control @error('') invalid @enderror" id="message" name="message" id="exampleFormControlTextarea"
            ...
            <div class="bg-dark p-5" data-aos="fade-right">
                <form id="message-form" method="POST">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-12">
                            <textarea name="message" class="form-control @error('') invalid @enderror bg-light border-0 px-4 py-3" id="message" rows="4" placeholder="{{ __('general.message')}}"></textarea>
                            <div id="message_err" class="err"></div>
                        </div>
                        <div class="col-12">
