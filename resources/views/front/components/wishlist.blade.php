                ...
                <div class="product-box-3 h-100">
                    <div class="product-header">
                        <div class="product-image">
                            <a href="product-left-thumbnail.html">
                                <img src="{{asset('template/assets/images/cake/product/2.png')}}" class=" img-fluid img-fluid blur-up lazyload"
                                    alt="">
                            </a>
                    ...
                    <div class="product-footer">
                        <div class="product-detail">
                            <span class="span-name">{{ __('general.Vegetable') }}</span>
                            <a href="product-left-thumbnail.html">
                            ...
                            <div class="add-to-cart-box bg-white mt-2">
                                ...
                                <div class="cart_qty qty-box">
                                    <div class="input-group bg-white">
                                        ...
                                        <input class="form-control @error('') invalid @enderror input-number qty-input" type="text"
            ...
            <div class="col-xxl-2 col-lg-3 col-md-4 col-6 product-box-contain">
                <div class="product-box-3 h-100">
                    <div class="product-header">
                        <div class="product-image">
                            <a href="product-left-thumbnail.html">
                                <img src="{{asset('template/assets/images/cake/product/3.png')}}" class=" img-fluid img-fluid blur-up lazyload"
                                    alt="">
                            </a>
            ...
            <div class="col-xxl-2 col-lg-3 col-md-4 col-6 product-box-contain">
                <div class="product-box-3 h-100">
                    <div class="product-header">
                        <div class="product-image">
                            <a href="product-left-thumbnail.html">
                                <img src="{{asset('template/assets/images/cake/product/4.png')}}" class=" img-fluid img-fluid blur-up lazyload"
                                    alt="">
                            </a>
                    ...
                    <div class="product-footer">
                        <div class="product-detail">
                            <span class="span-name">{{ __('general.Snacks') }}</span>
                            <a href="product-left-thumbnail.html">
            ...
            <div class="col-xxl-2 col-lg-3 col-md-4 col-6 product-box-contain">
                <div class="product-box-3 h-100">
                    <div class="product-header">
                        <div class="product-image">
                            <a href="product-left-thumbnail.html">
                                <img src="{{asset('template/assets/images/cake/product/5.png')}}" class=" img-fluid img-fluid blur-up lazyload"
                                    alt="">
                            </a>
            ...
            <div class="col-xxl-2 col-lg-3 col-md-4 col-6 product-box-contain">
                <div class="product-box-3 h-100">
                    <div class="product-header">
                        <div class="product-image">
                            <a href="product-left-thumbnail.html">
                                <img src="{{asset('template/assets/images/cake/product/6.png')}}" class=" img-fluid img-fluid blur-up lazyload"
                                    alt="">
                            </a>
            ...
            <div class="col-xxl-2 col-lg-3 col-md-4 col-6 product-box-contain">
                <div class="product-box-3 h-100">
                    <div class="product-header">
                        <div class="product-image">
                            <a href="product-left-thumbnail.html">
                                <img src="{{asset('template/assets/images/cake/product/7.png')}}" class=" img-fluid img-fluid blur-up lazyload"
                                    alt="">
                            </a>
            ...
            <div class="col-lg-4 col-md-6" data-aos="zoom-in">
                <div class="team-item position-relative">
                    <div class="position-relative overflow-hidden rounded">
                        <img class=" img-fluid img-fluid team-image" src="{{ asset( $team->image )}}" alt="">
