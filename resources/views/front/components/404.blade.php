    ...
    <section class="section-404 section-lg-space">
        <div class="container-fluid-lg">
            <div class="row">
                <div class="col-12">
                    <div class="image-404">
                        <img src="{{ asset('template/assets/images/inner-page/404.png') }}" class=" img-fluid img-fluid blur-up lazyload" alt="">
                    </div>
                </div>
    ...
    <div class="container">
		...
		<div class="error-contents">
			...
			<div class="error-img">
				<img class=" img-fluid img-fluid" src="images/404.png" alt="" />
			</div>
			<p>We can’t find the page your are looking for. You can check out our <a href="#">{{ __('general.Homepage') }}</a>.</p>
