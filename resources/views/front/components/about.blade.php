    ...
    <section class="about-page section-b-space">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="banner-section"><img src="{{asset("front/assets/images/about/about-us.jpg")}}"
    ...
    <section class="testimonial small-section">
        <div class="container">
            <div class="title1">
                <h4>{{ __('general.LatestTestimonials') }}</h4>
                <h2 class="title-inner1">{{ __('general.WhatPeopleSay') }}</h2>
            </div>
            <div class="slide-2 testimonial-slider no-arrow">
                <div>
                    <div class="media">
                        <div class="text-center">
                            <img src="{{asset("front/assets/images/avtar.jpg")}}" alt="#">
                            <h5>{{ __('general.MarkJunco') }}</h5>
                            <h6>{{ __('general.Designer') }}</h6>
                        </div>
                ...
                <div>
                    <div class="media">
                        <div class="text-center">
                            <img src="{{asset("front/assets/images/avtar.jpg")}}" alt="#">
                            <h5>{{ __('general.MarkJunco') }}<eral.MarkJunco') }}</h5>
                            <h6>{{ __('general.Designer') }}</h6>
                        </div>
                        <div class="media-body">
                            <p>you how all this mistaken idea of denouncing pleasure and praising pain was born
    ...
    <!--Team start-->
    <section id="team" class="team section-b-space slick-default-margin">
        <div class="container">
            <div class="title1">
                <h2 class="title-inner1 border-0">{{ __('general.MultikartTeamMember') }}</h2>
            </div>
            <div class="team-4 no-arrow">
                <div>
                    <div>
                        <img src="{{asset("front/assets/images/team/1.jpg")}}" class="img-fluid blur-up lazyload" alt="">
                    </div>
                    <h4>{{ __('general.HileriKeol') }}</h4>
                    <h6>{{ __('general.CEo&FounderAtCompany') }}</h6>
                </div>
                <div>
                    <div>
                        <img src="{{asset("front/assets/images/team/2.jpg")}}" class="img-fluid blur-up lazyload" alt="">
                    </div>
                    <h4>{{ __('general.HileriKeol') }}</h4>
                    <h6>{{ __('general.CEo&FounderAtCompany') }}<underAtCompany') }}<underAtCompany') }}</h6>
                </div>
                <div>
                    <div>
                        <img src="{{asset("front/assets/images/team/3.jpg")}}" class="img-fluid blur-up lazyload" alt="">
                    </div>
                    <h4>{{ __('general.HileriKeol') }}<ral.HileriKeol') }}<ral.HileriKeol') }}</h4>
                    <h6>{{ __('general.CEo&FounderAtCompany') }}</h6>
                </div>
                <div>
                    <div>
                        <img src="{{asset("front/assets/images/team/4.jpg")}}" class="img-fluid blur-up lazyload" alt="">
                    </div>
                    <h4>{{ __('general.HileriKeol') }}</h4>
                    <h6>{{ __('general.CEo&FounderAtCompany') }}</h6>
                </div>
            ...
            <div class="row">
                <div class="col-md-4 service-block">
                    <div class="media">
                        ...
                        <div class="media-body">
                            <h4>{{ __('general.freeshipping') }}</h4>
                            <p>{{ __('general.freeshippingworldwide') }}</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-4 service-block">
                    <div class="media">
                        ...
                        <div class="media-body">
                            <h4>{{ __('general.24X7service') }}</h4>
                            <p>{{ __('general.onlineservicefornewcustomer') }}</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-4 service-block">
                    <div class="media">
                        ...
                        <div class="media-body">
                            <h4>{{ __('general.festivaloffer') }}</h4>
                            <p>{{ __('general.newonlinespecilfestivaloffer') }}</p>
                        </div>
                    </div>
                </div>
            </div>
