                    ...
                    <div class="faq-image-wrap">
                        <div class="thumb"> --}}
                            ...
                            {{-- <img src="{{ asset(isset(page('faq-section')->images[0]->url) ? page('faq-section')->images[0]->url : asset('default.jpg')) }}"
                                alt="img"> --}}
                            {{-- <img class=" img-fluid img-position-1" src="{{asset('assets/img/about/f2.webp')}}" alt="img"> --}}
                            {{-- <img class=" img-fluid img-position-2 top_image_bounce" src="{{asset('assets/img/about/f3.webp')}}" alt="img"> --}}
                        {{-- </div>
                    </div>
                </div>
        ...
        <script>
            $(document).ready(function() {
                $(document).on('click','#showMore', function() {
                    ...
                    $('#showMore').html("{{ __('general.show_less')}}");
                    $('#showMore').attr('id', 'showLess');
                });

                $(document).on('click','#showLess', function() {
                    $('.showMore').addClass('d-none');
                    $('#showLess').html("{{ __('general.show_more')}}");
