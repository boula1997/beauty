...
@if ($category->id == 2)
<div id="toggleMosques">
    @include('front.components.mosques')
    @include('front.components.products-home',['title'=>'عروض المساجد'])
    @include('front.components.products-home',['title'=>'المنتجات'])
</div>
@endif
        ...
        {{-- @foreach ($category->companies as $company) --}}
                <section class="mb-3">
                    <div class="container-fluid-lg">
                        <div class="title">
                            <h2>{{ __('general.browse_by_companies')}}</h2>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="slider-9">
                                    @foreach ($category->companies as $company)
                                        <div>
                                            <a href="{{ route('front.company', $company->id) }}"
