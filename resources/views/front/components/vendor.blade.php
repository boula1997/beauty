    ...
    <section class="about-page section-b-space">
        <div class="container">
            <div class="banner-section"><img src="{{asset("front/assets/images/about/vendor.jpg")}}" class="img-fluid blur-up lazyload"
                    alt="">
    ...
    <div class="container">
        <section class="service section-b-space pt-0 ">
            <div class="row partition4 ">
                <div class="col-lg-3 col-md-6">
                    <div class="service-block1">
                        ...
                        <h4>{{ __('general.lowest_cost') }}</h4>
                        <p>{{ __('general.lowest_cost_description') }}</p>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="service-block1">
                        ...
                        <h4>{{ __('general.high_growth_rate') }}</h4>
                        <p>{{ __('general.high_growth_rate_description') }}</p>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="service-block1">
                        ...
                        <h4>{{ __('general.dedicated_pickup') }}</h4>
                        <p>{{ __('general.dedicated_pickup_description') }}</p>
			...
			c16.277-5.525,51.243-15.019,101.995-16.213V309.33z" />
                        ...
                        <h4>{{ __('general.most_approachable') }}</h4>
                        <p>{{ __('general.most_approachable_description') }}</p>
    ...
    <section class="section-b-space become-vendor">
        <div class="container">
            <h4>{{ __('general.easy_business') }}</h4>
                    ...
                    <div class="col-lg-4">
                        <div class="step-box">
                            <div>
                                ...
                                <h4>{{ __('general.list_products') }}</h4>
                                <p>{{ __('general.list_products_desc') }}</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4">
                        <div class="step-box">
                            <div>
                                ...
                                <h4>{{ __('general.receive_orders') }}</h4>
                                <p>{{ __('general.receive_orders_desc') }}</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4">
                        <div class="step-box">
                            <div>
                                ...
                                <h4>{{ __('general.quick_payment') }}</h4>
                                <p>{{ __('general.quick_payment_desc') }}</p>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <section class="start-selling section-b-space">
        <div class="container">
            <div class="col">
                <div>
                    <h4>{{ __('general.startselling') }}</h4>
                    <p>Multikart marketplace is India's leading platform for selling online. Be it a manufacturer,
                        vendor or supplier, simply sell your products online on Multikart and become a top ecommerce
                        player with minimum investment. Through a team of experts offering exclusive seller workshops,
                        training, seller support and convenient seller portal, Multikart focuses on educating and
                        empowering sellers across India. Selling on Multikart.com is easy and absolutely free. All you
                        need is to register, list your catalogue and start selling your products.</p>
                    <a href="{{route('front.home')}}" class="btn btn-solid btn-sm">start selling</a>
                </div>
            </div>
        </div>
    </section>
