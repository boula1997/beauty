...
@section('content')
    ...
    <div class="page-wrapper">
        <div class="authentication-box">
            <div class="container">
                @if (session('success'))
                    <div class="alert alert-success alert-dismissible fade show text-center w-100 my-3" role="alert">
                        {{ session('success') }}
                ...
                @if (session('error'))
                    <div class="alert alert-danger alert-dismissible fade show text-center w-100 my-3" role="alert">
                        {{ session('error') }}
                        <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                    </div>
                @endif
                <div class="row">
                            ...
                            <div class="card-body">
                                <ul class="nav nav-tabs nav-material" id="top-tab" role="tablist">
                                    <li class="nav-item">
                                        <a class="nav-link active" id="top-profile-tab" data-bs-toggle="tab"
                                            ...
                                            aria-selected="true"><span class="icon-user me-2"></span>{{ __('general.MerchantRegister') }}</a>
                                    </li>
                                </ul>
                                <div class="tab-content" id="top-tabContent">
                                    <div class="tab-pane fade show active" id="top-profile" role="tabpanel"
                                        ...
                                        @else
                                            <form class="form-horizontal auth-form" method="POST" action="{{ route('merchant.register') }}">
                                                @endisset
                                                @csrf
                                                <div class="row">
                                                    <div class="col-6">
                                                        <div class="form-group">
                                                            <input   name="storeName" type="string"
                                                                class="form-control" placeholder="{{ __('general.storeName') }}" id="exampleInputEmail1" value="{{ old('storeName') }}" autocomplete="storeName" autofocus>
                                                            @error('storeName')
                                                    ...
                                                    <div class="col-6">
                                                        <div class="form-group">
                                                            <input   name="merchantName" type="string"
                                                                class="form-control" placeholder="{{ __('general.merchantName') }}" id="exampleInputEmail1" value="{{ old('merchantName') }}" autocomplete="merchantName" autofocus>
                                                            @error('merchantName')
                                                                <span class="text-danger" >
                                                                    <strong>{{ $message }}</strong>
                                                                </span>
                                                    ...
                                                    <div class="col-6">
                                                        <div class="form-group">
                                                            <input   name="email" type="string"
                                                                class="form-control" placeholder="{{ __('general.email') }}" id="exampleInputEmail1" value="{{ old('email') }}" autocomplete="email" autofocus>
                                                            @error('email')
                                                                <span class="text-danger" >
                                                                    <strong>{{ $message }}</strong>
                                                                </span>
                                                    ...
                                                    <div class="col-6">
                                                        <div class="form-group">
                                                            <input   name="phone" type="string"
                                                                class="form-control" placeholder="{{ __('general.phone') }}" id="exampleInputEmail1" value="{{ old('phone') }}" autocomplete="phone" autofocus>
                                                            @error('phone')
                                                                <span class="text-danger" >
                                                                    <strong>{{ $message }}</strong>
                                                                </span>
                                                    ...
                                                    <div class="col-12">
                                                        <div class="form-group">
                                                            <input   name="address" type="text"
                                                                class="form-control" placeholder="{{ __('general.address') }}" id="exampleInputEmail1" value="{{ old('address') }}" autocomplete="address" autofocus>
                                                            @error('address')
                                                                <span class="text-danger" >
                                                                    <strong>{{ $message }}</strong>
                                                                </span>
                                                    ...
                                                    <div class="col-12">
                                                        <div class="form-group">
                                                            <input   name="username" type="text"
                                                                class="form-control" placeholder="{{ __('general.username') }}" id="exampleInputEmail1" value="{{ old('username') }}" autocomplete="username" autofocus>
                                                            @error('username')
                                                                <span class="text-danger" >
                                                                    <strong>{{ $message }}</strong>
                                                                </span>
                                                    ...
                                                    <div class="col-12">
                                                        <div class="input-group mb-3">
                                                            <input name="password" id="password" type="password"
                                                                class="form-control" placeholder="{{ __('general.password') }}">
                                                            <span class="input-group-text togglePassword" data-target="password" style="cursor: pointer;">
                                                                <i class="fa fa-eye"></i>
                                                            </span>
                                                        </div>
                                                        @error('password')
                                                    ...
                                                    <div class="col-12">
                                                        <div class="input-group mb-3">
                                                            <input name="confirm_password" id="confirm_password" type="password"
                                                                class="form-control" placeholder="{{ __('general.confirm_password') }}">
                                                            <span class="input-group-text togglePassword" data-target="confirm_password" style="cursor: pointer;">
                                                                <i class="fa fa-eye"></i>
                                                            </span>
                                                        </div>
                                                ...
                                                <div class="form-button">
                                                    <button class="btn btn-primary" type="submit">{{ __('general.sendRegisterRequest') }}</button>
                                                </div>

                                                <div class="form-terms mt-3 d-flex justify-content-center">
                                                    <div class="form-check mesm-2">
                                                        <a href="{{ route('merchant.login') }}"
                                                            class="btn btn-default forgot-pass">{{ __('general.haveAnAccount!') }}</a>
                                                    </div>
                                                </div>
                    ...
                    <div>
                        <a href="{{ route('front.home') }}" class="btn btn-primary back-btn"><i data-feather="arrow-left"></i>{{ __('general.back') }}</a>
                    </div>
                </div>
            </div>
        </div>
