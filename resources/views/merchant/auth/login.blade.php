                            ...
                            <div class="card-body">
                                <ul class="nav nav-tabs nav-material" id="top-tab" role="tablist">
                                    <li class="nav-item">
                                        <a class="nav-link active" id="top-profile-tab" data-bs-toggle="tab"
                                            ...
                                            aria-selected="true"><span class="icon-user me-2"></span>{{ __('general.MerchantLogin') }}</a>
                                    </li>
                                </ul>
                                <div class="tab-content" id="top-tabContent">
                                    <div class="tab-pane fade show active" id="top-profile" role="tabpanel"
                                        ...
                                        @else
                                            <form class="form-horizontal auth-form" method="POST" action="{{ route('merchant.login') }}">
                                                @endisset
                                                @csrf

                                                <div class="form-group">
                                                    <input required="" name="username" type="string"
                                                ...
                                                <div class="form-terms">
                                                    <div class="form-check mesm-2">
                                                        ...
                                                        <label class="form-check-label ps-2"
                                                            for="customControlAutosizing">{{ __('general.remember_me') }}</label>
                                                        <a href="javascript:void(0)"
                                                            class="btn btn-default forgot-pass">{{ __('general.forget_password') }}</a>
                                                    </div>
                                                </div>
                                                <div class="form-button">
                                                    <button class="btn btn-primary" type="submit">{{ __('general.login') }}</button>
                                                </div>
                                                
                                                
                                                <div class="text-center mt-3">
                                                    <span>{{ __('general.no_account') }}</span>
                                                    <a href="{{ route('merchant.register') }}" class="btn btn-default forgot-pass">{{ __('general.register_here') }}</a>
                                                </div>
