    ...
    <div class="page-sidebar">
        ...
        <div class="sidebar custom-scrollbar">
            ...
            <ul class="sidebar-menu">
                <li>
                    <a class="sidebar-header" href="{{ route('merchant.dashboard') }}">
                ...
                {{-- itemRequests --}}
                    <li>
                        <a class="sidebar-header" href="javascript:void(0)">
                            <i data-feather="box"></i>
                            <span>{{ __('general.itemRequests') }}</span>
                            <i class="fa fa-angle-right pull-right {{ app()->getLocale()=="ar"?"rotate":"" }}"></i>
                        </a>
                        <ul class="sidebar-submenu">
                            
                            <li>
                                <a href="{{ route('merchant.itemRequests.index') }}">
                                    <i class="fa fa-circle"></i>{{ __('general.itemRequest_list') }}
                                </a>
                            </li>
                        
                                <li>
                                    <a href="{{ route('merchant.itemRequests.create') }}">
                                        <i class="fa fa-circle"></i>{{ __('general.create_itemRequest') }}
                                    </a>
                                </li>
                        </ul>
                    </li>
