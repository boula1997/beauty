...
@section('form_action', route('merchant.itemRequests.update', $itemRequest->id))
                        ...
                        @foreach (config('translatable.locales') as $key => $locale)
                            <div class="tab-pane fade @if ($key == 0) show active @endif"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="{{ $locale . '[title]' }}" id="title_{{ $locale }}" class="form-control"
                                ...
                                <div class="col-form-group ">
                                    ...
                                    <textarea rows="5" class="form-control @error($locale . '.description') is-invalid @enderror"
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <input name="store_id" type="text" class="form-control" value="{{ $data['store_id'] }}">
                        </div>
                        <div class="col-md-6">
                            <label>{{ __('general.brand') }}</label>
                            <input type="text" name="brand_id" class="form-control" value="{{ $data['brand_id'] }}">
                        </div>
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="subcategory_id" class="form-control" value="{{ $data['subcategory_id'] ?? 'N/A' }}">
                        </div>
                        <div class="col-md-6">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <input type="text" name="startDate" class="form-control" value="{{ $data['startDate'] ?? 'N/A' }}">
                        </div>
                        <div class="col-md-6">
                            <label>{{ __('general.end_date') }}</label>
                            <input type="text" name="endDate" class="form-control" value="{{ $data['endDate'] ?? 'N/A' }}">
                        </div>
                        <div class="col-md-6">
                            <label>{{ __('general.percentage') }}</label>
                            <input type="text" name="percentage" class="form-control" value="{{ $data['percentage'] ?? 'N/A' }}">
                        </div>
                    </div>
                </div>
