        ...
        <div class="container p-3">
            <div class="card card-custom card-stretch gutter-b">
                <div class="card-header card-header-tabs-line">
                    @include('admin.components.breadcrumb', ['module' => 'pages', 'action' => 'show'])
                </div>
                        ...
                        @foreach (config('translatable.locales') as $key => $locale)
                            <div class="tab-pane fade show @if ($key == 0) active @endif"
                                ...
                                <div class="row">
                                    ...
                                    <!-- url input show --> <div class="col-md-6"> <div class="mb-5 bg-light p-3 rounded h-100"> <div class="card-title fw-bold"> <h5 class="font-weight-bolder text-dark"> {{ __('general.youtube_link') }}:</h5> <a href="{{ $page->youtube_link }}">{{ $page->youtube_link }}</a> </div> </div> </div>
