    ...
    <div class="content-wrapper">
            ...
            <div class="card card-custom mb-2">
                <div class="card-header card-header-tabs-line">
                    @include('admin.components.breadcrumb', ['module' => 'pages', 'action' => 'create'])
                </div>
                            ...
                            <div class="form-group">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="identifier" value="{{ old('identifier') }}"
                                        class="form-control @error('') invalid @enderror  pl-1 min-h-40px" id="exampleInputName" placeholder="{{__('general.identifier')}}">
                                </div>
                            </div>
