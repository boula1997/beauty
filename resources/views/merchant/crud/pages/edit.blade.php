                            ...
                            <div class="form-group">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="identifier"
                                        ...
                                        id="exampleInputName" placeholder="{{__('general.identifier')}}">
                                </div>
                            </div>
