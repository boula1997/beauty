                    ...
                    <div class="tab-content">
                        @foreach (config('translatable.locales') as $key => $locale)
                            <div class="tab-pane fade show @if ($key == 0) active @endif"
                                ...
                                <div class="form-group">
                                    <label>{{__('general.address')}}- @lang('general.' . $locale)<span class="text-danger"> * </span></label>
                                    <div class="input-group">
                                        <div class="input-group-prepend">
                                            <span class="input-group-text"><i class="fas fa-pen"></i></span>
                                        </div>
                                ...
                                <div class="form-group">
                                    <label>{{__('general.appointment')}}- @lang('general.' . $locale)<span class="text-danger"> *
                                        </span></label>
                                    <div class="input-group">
                                        <div class="input-group-prepend">
                                            <span class="input-group-text"><i class="fas fa-pen"></i></span>
                                        </div>
                                        <input type="text" name="{{ $locale . '[appointment]' }}"
                                            placeholder="{{__('general.appointment')}}"
                                            class="form-control @error('') invalid @enderror  pl-1 min-h-40px @error($locale . '.appointment') is-invalid @enderror"
                                            value="{{ old($locale . '.appointment', $setting->translate($locale)->appointment) }}">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label>{{__('general.copyright')}}- @lang('general.' . $locale)<span class="text-danger"> *
                                        </span></label>
                                    <div class="input-group">
                                        <div class="input-group-prepend">
                                            <span class="input-group-text"><i class="fas fa-pen"></i></span>
                                ...
                                <div class="form-group">
                                    <label>{{__('general.meta_data')}}- @lang('general.' . $locale)<span class="text-danger"> *
                                        </span></label>
                                    <div class="input-group">
                                        <div class="input-group-prepend">
                                            <span class="input-group-text"><i class="fas fa-pen"></i></span>
                                        ...
                                        <input type="text" name="{{ $locale . '[meta_data]' }}"
                                            placeholder="{{__('general.meta_data')}}"
