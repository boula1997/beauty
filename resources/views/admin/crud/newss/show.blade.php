                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="title-header option-title">
                                        <h5>{{ __('general.show') }} {{ __('general.newss') }}</h5>
                                    </div>
                                            ...
                                            <div class="tab-pane fade show @if ($key == 0) active @endif"
                                                ...
                                                <div class="col-sm-12">
                                                    <div class="mb-4 row align-items-center">
                                                        ...
                                                        <p class="col-sm-9">{{ $news->translate($locale)->title }}</p>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-sm-12">
                                                    <div class="mb-4 row align-items-center">
                                                        <label
                                                            ...
                                                            -
                                                            @lang('general.' . $locale)</label>
                                                        <p class="col-sm-9">{{ $news->translate($locale)->subtitle }}</p>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-sm-12">
                                                    <div class="mb-4 row align-items-center">
                                                        <label
                                                            ...
                                                            -
                                                            @lang('general.' . $locale)</label>
                                                        <p class="col-sm-9">{!! $news->translate($locale)->description !!}</p>
                                                    </div>
                                                </div>
                                            </div>
                                        @endforeach
