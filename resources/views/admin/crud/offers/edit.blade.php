...
@section('form_action', route('offers.update', $offer->id))
        ...
        @method('PUT')
            ...
            <div class="card card-custom mb-2">
                <div class="card-header card-header-tabs-line">
                    @include('admin.components.breadcrumb', ['module' => 'offers', 'action' => 'edit'])
                </div>
                            ...
                            <div class="tab-pane fade show @if ($key == 0) active @endif"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="{{ $locale . '[title]' }}"
                                            ...
                                            value="{{ old($locale . '.title', $offer->translate($locale)->title) }}">
                                    </div>
                                </div>

                                <div class="form-group">
                                    <label>{{__('general.link')}}- @lang('general.' . $locale)<span class="text-danger"> * </span></label>
                                    <div class="input-group">
                                        <div class="input-group-prepend">
                                        ...
                                        <input type="text" name="{{ $locale . '[subtitle]' }}"
                                            ...
                                            value="{{ old($locale . '.subtitle', $offer->translate($locale)->subtitle) }}">
                                    </div>
                                </div>
                                ...
                                <div class="col-form-group">
                                    ...
                                    <textarea rows="100" class="summernote @error($locale . '.description') is-invalid @enderror"
                                        ...
                                        {!! old($locale . '.description', $offer->translate($locale)->description) !!} 
                                    </textarea>
                                </div>
                            </div>
                        @endforeach
            ...
            <div class="card card-custom">
                ...
                <div class="card-footer mb-5 mt-5">
                    ...
                    <a href="{{ route('offers.index') }}" class="btn btn-outline-danger font-weight-bold">{{__('general.cancel')}}</a>
                </div>
            </div>
        </div>
    </div>
