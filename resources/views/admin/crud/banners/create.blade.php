...
@section('form_action', route('banners.store'))
        ...
        <div class="container p-3">
            <div class="card card-custom mb-2">
                <div class="card-header card-header-tabs-line">
                    @include('admin.components.breadcrumb', ['module' => 'banners', 'action' => 'create'])
                </div>
                            ...
                            <div class="col-md-3">
                                <div class="mb-3">
                                    ...
                                    <select class="custom-select form-control" name="type" id="types">
                                        ...
                                        <option value="1" {{ old('type') == 1 ? 'selected' : '' }}>@lang('general.banner_category')</option>
                                        <option value="2" {{ old('type') == 2 ? 'selected' : '' }}>@lang('general.banner_flash_sale')</option>
                                    </select>
                                    @error('type')
