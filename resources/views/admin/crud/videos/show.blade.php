                            ...
                            <div class="card">
                                <div class="card-body">
                                            ...
                                            <div class="tab-pane fade show @if ($key == 0) active @endif"
                                                ...
                                                <div class="col-sm-12"> 
                                                    <div class="mb-4 row align-items-center">
                                                        ...
                                                        <p class="col-sm-9">{{  $video->translate($locale)->title}}</p>
                                                    </div>
                                                </div>
                                    ...
                                    <div class="col-sm-12"> 
                                        <div class="mb-4 row align-items-center">
                                            <label
                                                class="form-label-title col-sm-3 mb-0">{{ __('general.youtube_link') }}</label>
                                            <a class="col-sm-9" href="{{ $video->youtube_link }}" target="__blank">{{ $video->youtube_link }}</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
